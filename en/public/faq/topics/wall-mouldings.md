...
kategorie: "FAQ"
tags: ["Wall mouldings", "Profiled trims", "Wood", "Interior design", "Restoration", "Historic building"]
...
- **Bar profiles** (multi-stepped, with chamfers or coves)

- **Cornices** (cove moulding, cyma, cornice moulding)

- **Decorative trims** (bead, egg-and-dart, floral and ornamental profiles)
...
- For structuring large wall surfaces (frames, fields, panels)

- For protecting exposed edges (e.g. in corridors, stairwells)

- For the junction between wall and ceiling (cornice trims)
...
- According to historic originals or custom designs
...
- Concealed fixing (nails, screws, glue) for an attractive finish

- Careful joint sealing, especially in changing room climates
...
- Production of sample pieces for approval

- Faithful reproduction of materials and profiles in repairs
