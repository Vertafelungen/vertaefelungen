...
<!-- bucket:beschreibung -->
## Produktbasis: Lackleinöl + Marken-Sikkative (Herstellerangabe)
...
<!-- bucket:beschreibung -->
## Begriffe: Lackleinöl, Firnis, "maßhaltig" vs. "nicht maßhaltig"
...
<!-- bucket:varianten -->
## Besonders helles Lackleinöl-Firnis (gebleicht) (Herstellerangabe)
...
<!-- bucket:praxis -->
## Einsatzbereiche (Herstellerangaben + allgemeine Systemlogik)
...
<!-- bucket:praxis -->
## Verarbeitung - Außenbereich (Herstellerangabe)
...
<!-- bucket:praxis -->
## Verarbeitung - Innenbereich (Herstellerangabe)
...
<!-- bucket:praxis -->
## Trocknung, Durchhärtung, Geruch (Innenräume)
...
<!-- bucket:kosten -->
## Verbrauch und Reichweite (Richtwerte)
...
<!-- bucket:fehler -->
## Sicherheit, Lagerung, Entsorgung (Herstellerangabe + Standardhinweis)
