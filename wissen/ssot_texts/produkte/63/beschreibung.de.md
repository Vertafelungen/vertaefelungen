<!-- ssot_texts | v2026-03-17 07:53 Europe/Berlin | source:SSOT.csv:beschreibung_md_de | id:63 -->

# Balsamterpentinöl

## Wofür ist Balsamterpentinöl? <!-- bucket:kurzantwort -->
...
## Herkunft, Rohstoffbasis und Kohlenstoffkreislauf <!-- bucket:beschreibung -->
Balsamterpentinöl ist ein Destillat aus Nadelholzharz – nicht aus Erdöl. Terpene sind natürliche Inhaltsstoffe von Nadelholz und Harz. In natürlichen Waldökosystemen werden Terpene auch ohne Nutzung freigesetzt – etwa durch Zersetzungsprozesse und Verrottung. Balsamterpentinöl nutzt diese natürlich vorkommenden Harzbestandteile als Rohstoff; der Kohlenstoff ist dabei nicht fossil, sondern Teil des biogenen Kohlenstoffkreislaufs.
...
## Einsatzbereiche <!-- bucket:beschreibung -->
...
• steuert Offenzeit, Verlauf, Lasurverhalten  
• geeignet zum Reinigen von Pinseln/Paletten von öl- und harzhaltigen Medien  

## Anwendungsbeispiele <!-- bucket:praxis -->
...
## Rezepte <!-- bucket:ablauf -->
### Rezept 1: Holzschutz-Grundierung - klassisches Halböl
...
## Sicherheits- und Kompatibilitätshinweise <!-- bucket:fehler -->
...
Achtung: Mit Öl oder Balsamterpentin getränkte Lappen können sich selbst entzünden. Diese stets ausgebreitet trocknen lassen oder kontrolliert entsorgen.

## Technische Merkmale <!-- bucket:beschreibung -->
• Zusammensetzung: 100 % Balsamterpentinöl  
• Siedepunkt: ca. 150–180 °C  
• Flammpunkt: ca. 36 °C  
• Zündtemperatur: ca. 220 °C  
• Einstufung gemäß ChemVOCFarbV: organisches Lösungsmittel  
• Eigenschaft: leicht biologisch abbaubar  
Dieses Produkt unterliegt den geltenden Vorschriften für Gefahrstoffe. Maßgeblich sind stets die Angaben auf dem Etikett sowie das zugehörige Sicherheitsdatenblatt.

## Nicht kompatibel mit <!-- bucket:fehler -->
...
Shop: https://www.vertaefelungen.de/de/leinoel-tungoel-balsam/63-313-balsamterpentinol.html#/63-1_25_5_10_20_liter-1_liter
