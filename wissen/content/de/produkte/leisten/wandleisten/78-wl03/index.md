---
aliases:
- /de/produktinfo/public/leisten/wandleisten/78-wl03/
...
produkt:
  ...
  bilder: []
seo:
  title: wl03 - Riffelleiste - Massive Holzleiste 10 x 40 mm.<br
  description: Riffelleiste - Massive Holzleiste 10 x 40 mm. In Kiefer oder White Wood, andere Holzarten aus Anfrage. Als Wandleiste zur direkten Montag.
  tags: []
refs:
  source_shop: ''
lang: de
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_kurzantwort | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->

- Wandleiste 03 „Riffelleiste" ist eine profilierte Wandleiste für klassische Wandgliederungen im Innenbereich.
...
- Für ein stimmiges Ergebnis sollten Profilhöhe und Raummaß gemeinsam betrachtet werden.

## Praxis-Kontext

<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_praxis | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_varianten | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_ablauf | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_kosten | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_fehler | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
<!-- ssot_texts | v2026-02-28 10:50 Europe/Berlin | source: SSOT.csv:body_de_verweise | product_id:78 | reference:WL 03 | slug_de:wl03 | slug_en:wl03 -->
...
### <!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:question | faq_id:p-78-de-001 | lang:de | scope_type:product | scope_key:78 -->

Wofür eignet sich dieses Wandleisten-Profil?

<!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:answer | faq_id:p-78-de-001 | lang:de | scope_type:product | scope_key:78 -->
...
### <!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:question | faq_id:p-78-de-002 | lang:de | scope_type:product | scope_key:78 -->

Kann ich das Profil in Altbauwänden mit Unebenheiten einsetzen?

<!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:answer | faq_id:p-78-de-002 | lang:de | scope_type:product | scope_key:78 -->
...
### <!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:question | faq_id:p-78-de-003 | lang:de | scope_type:product | scope_key:78 -->

Wie kombiniere ich die Leiste mit anderen Profilen?

<!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:answer | faq_id:p-78-de-003 | lang:de | scope_type:product | scope_key:78 -->

Am besten wird zuerst das Türdetail definiert, danach werden Sockel- und Wandleisten auf dieses Referenzdetail abgestimmt.

### <!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:question | faq_id:p-78-de-004 | lang:de | scope_type:product | scope_key:78 -->

Welche Fehler passieren bei der Montage am häufigsten?

<!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:answer | faq_id:p-78-de-004 | lang:de | scope_type:product | scope_key:78 -->
...
### <!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:question | faq_id:p-78-de-005 | lang:de | scope_type:product | scope_key:78 -->

Brauche ich vorab eine vollständige Raumplanung?

<!-- ssot_texts | v2026-02-28 11:10 Europe/Berlin | source: faq.csv:answer | faq_id:p-78-de-005 | lang:de | scope_type:product | scope_key:78 -->
