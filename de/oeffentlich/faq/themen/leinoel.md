...
slug: "faq-leinoel"
kategorie: "FAQ"
tags: ["Leinöl", "Holzschutz", "Oberflächenbehandlung", "Denkmalpflege", "Naturöl", "Firnis"]
...
- Es handelt sich um reines, ungekochtes und nicht chemisch verändertes Leinöl.

- Es trocknet langsam an der Luft (oft mehrere Tage), dringt tief ins Holz ein und sorgt für eine lange Offenzeit.

- Es wird häufig für traditionelle Imprägnierungen, in der Restaurierung und im Holzschutz im Außenbereich verwendet.

**Leinölfirnis:**

- Leinölfirnis ist durch Kochen (meist mit Zusätzen wie Trockenstoffen/Sikkativen) hergestelltes Leinöl.

- Es trocknet deutlich schneller als rohes Leinöl (oft innerhalb eines Tages), bildet eine leicht glänzende Oberfläche und ist griffiger.
...
- Natürliche Herkunft, keine Lösungsmittel, hohe Diffusionsoffenheit

- Dringt tief ins Holz ein und schützt von innen

- Fördert die natürliche Alterung und Patina

- Nachhaltig, umweltfreundlich, gut restaurierbar

- Einfach zu erneuern (Auffrischung ohne Abschleifen)

**Nachteile:**

- Lange Trockenzeiten, besonders bei Leinöl Natur

- Geruchsentwicklung beim Trocknen

- Nicht filmbildend, daher begrenzter Schutz gegen stehendes Wasser
...
- **Empfehlungen der Bundesdenkmalämter, Fraunhofer IBP, BDA**
